...
resource "azurerm_virtual_network" "create_cluster_vnet" {
  ...
  subnet {
    ...
    address_prefix = var.address_prefixes_openshift_cluster_subnet
  }
  subnet {
    name             = "blueteam_cluster_subnet"
    address_prefix = var.address_prefixes_blueteam_cluster_subnet
  }
  subnet {
    name             = "services_cluster_subnet"
    address_prefix = var.address_prefixes_services_cluster_subnet
  }
  subnet {
    name             = "elk_cluster_subnet"
    address_prefix = var.address_prefixes_elk_cluster_subnet
  }
