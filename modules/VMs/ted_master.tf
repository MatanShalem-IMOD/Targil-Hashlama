# resource "azurerm_network_interface" "ted_managers_vm_nic" {
#   name                = "ted-managers-vm-nic"
...
# resource "azurerm_virtual_machine" "ted_managers_vm" {
#   name                  = "ted-managers-vm"
#   location              = var.red_vnet_location
#   resource_group_name   = var.cyber_resource_group_name
#   network_interface_ids = [azurerm_network_interface.ted_managers_vm_nic.id]
