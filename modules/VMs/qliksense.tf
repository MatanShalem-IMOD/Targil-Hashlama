resource "azurerm_network_interface" "qlik_vm_nic" {
  name                = var.qlik_vm_nic_name
...
resource "azurerm_virtual_machine" "qlik_vm" {
  name                  = var.qlik_vm_name
  location              = var.cluster_vnet_location
  resource_group_name   = var.cluster_vnet_resource_group_name
  network_interface_ids = [azurerm_network_interface.qlik_vm_nic.id]
  vm_size               = var.qlik_vm_size
