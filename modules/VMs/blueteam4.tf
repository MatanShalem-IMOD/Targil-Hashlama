resource "azurerm_network_interface" "blueteam4_vm_nic" {
  name                = var.blueteam4_vm_nic_name
...
resource "azurerm_virtual_machine" "blueteam4_vm" {
  name                  = var.blueteam4_vm_name
  location              = var.cluster_vnet_location
  resource_group_name   = var.cluster_vnet_resource_group_name
